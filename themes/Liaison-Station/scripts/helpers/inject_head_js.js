...
hexo.extend.helper.register("inject_head_js", function () {
  ...
  const themeColorLight = (theme_color?.enable && theme_color.meta_theme_color_light) || "#ffffff";
  const themeColorDark = (theme_color?.enable && theme_color.meta_theme_color_dark) || "#0d0d0d";
